...
namespace PATHFIND
{
	...
	static Any GENERATE_DIRECTIONS_TO_COORD(float x, float y, float z, Any p3, Any p4, Vehicle* vehicle, Any p6) { return invoke<Any>(0xF90125F1F79ECDF8, x, y, z, p3, p4, vehicle, p6); } // 0xF90125F1F79ECDF8 0xED35C094
...
namespace CONTROLS
{
	...
	static char* _0x0499D7B09FC9B407(int p0, int control, BOOL p2) { return invoke<char*>(0x0499D7B09FC9B407, p0, control, p2); } // 0x0499D7B09FC9B407 0x3551727A
...
namespace WATER
{
	...
	static void _SET_WAVES_HEIGHT(float height) { invoke<Void>(0xB96B00E976BE977F, height); } // 0xB96B00E976BE977F
}
